...
# 4) What is the value of each variable and why? (Answer as a comment)
    #they are both equal to 3 because both are set to equal 3 or to equal a variable equal to 3.
# 5) Set a equal to 7.

# 6) Print the value of a and the value of b

# 7) What is the value of each variable and why? (Answer as a comment)
    #they are both equal to 7 because both are set to equal 7 or to equal a variable equal to 3.